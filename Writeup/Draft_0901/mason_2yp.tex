...
%============================================================%
    ...
    \begin{alignat*}{1}
      U_{ijt} &= \beta_0 + \sum_1^k\beta_i^k X^k_{jt} + \gamma_i\Xi_{ijt}
    ...
    In the utility function, there are the following components: $\beta_0$ is a constant, $\beta^k$ is a consumer's utility from characteristic $X^k_{jt}$, $\gamma$ is their preference for variety, $\Xi_{jt}$ is the difference between the current characteristic and their most recent choice, $\alpha$ is price sensitivity to $p_{jt}$ and $\varepsilon_{jt}$ is the Gumbel shock which allows for a closed form logit. 
