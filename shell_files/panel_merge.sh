#!/bin/bash
#SBATCH --job-name=panelmerge		# Job name (testBowtie2)
...
#SBATCH --mem=125G			# Memory per node (4GB); by default using M as unit
#SBATCH --time=38:00:00              	# Time limit hrs:min:sec or days-hours:minutes:seconds
...
python /scratch/dtm63837/Kilts_Panel/LOV_CC_2YP/Code/dat_expo/panel_merge.py
