#!/bin/bash
#SBATCH --job-name=retailConvert		# Job name (testBowtie2)
...
#SBATCH --mem=200G			# Memory per node (4GB); by default using M as unit
...
python /scratch/dtm63837/Kilts_Panel/LOV_CC_2YP/Code/dat_expo/datCreate/retail_convert.py
